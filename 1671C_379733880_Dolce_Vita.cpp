// Codeforces Problem: 1671C - Dolce Vita
// Submission ID: 379733880
...
ll modMul(ll a, ll b) { return ((a % MOD) * (b % MOD)) % MOD; }
 ...
 // 2 1 2
// 1 2 2 = 5 + 3(n-1) <= 7 , n = 1 days , cnt = 3
// 1 2 = 3 + 2 + 2*(n-1) <= 7 , n = 2days , cnt = 4 
// 1 = 1 + 3 + 1(n-1) <=7 , n = 4 days , cnt = 4