...
void solve() {
    ...
    cin >> a >> b >> c >> m ;
 
    ll sol = m/(a) * 6 - m/(lcm(a,b)) * 3 - m/(lcm(a,c)) * 3 + m/(lcm(c,lcm(a,b)))*2 ;
        cout << sol << " " ;
    
    sol = m/(b) * 6 - m/(lcm(a,b)) * 3 - m/(lcm(b,c)) * 3 + m/(lcm(c,lcm(a,b)))*2 ;
        cout << sol << " " ;
 
    sol = m/(c) * 6 - m/(lcm(c,b)) * 3 - m/(lcm(a,c)) * 3 + m/(lcm(c,lcm(a,b)))*2 ;
        cout << sol << " " ;
 
    cout << '
' ;
